...
// the DETECTION-ONLY per-zone memory metric reads it. This exposes only a count; it allocates
// nothing and touches no script-reachable state. Mirror of state.go (kept in sync for regen).
