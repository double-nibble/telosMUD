...
func (d *mailDir) ClearPlayerShard(context.Context, string, string, string, uint64, uint64) (bool, error) {
	return true, nil
}

func (d *mailDir) RegisterPlacement(context.Context, string, string, string, uint64, uint64) (bool, error) {
	return true, nil
}
