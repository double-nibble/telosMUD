...
// TestPackSetGate (#259) pins the FAIL-CLOSED boot decision for the pack-set divergence check: a divergence
// (non-nil error) refuses to start unless TELOS_ALLOW_INSECURE was explicitly set (then it starts with a
// warning). A consistent pack set (nil error) always starts silently.
